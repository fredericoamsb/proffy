...
const TeacherItem: React.FC<TeacherItemProps> = ({ teacher, favorited }) => {
  ...
  async function handleToggleFavorite() {
    ...
    const favoritesArray = favorites ? JSON.parse(favorites) as Teacher[] : [];

    if (isFavorited) {
      const favoriteIndex = favoritesArray.findIndex((teacherItem: Teacher) => teacher.id === teacherItem.id);
